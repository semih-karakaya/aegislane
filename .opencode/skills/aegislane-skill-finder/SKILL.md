...
9. If the task involves an external library, SDK, framework, API, cloud service, CLI, or OpenCode configuration, prefer official docs through MCP/docs tools such as `context7` when available.
