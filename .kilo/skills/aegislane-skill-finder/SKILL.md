...
8. If the task involves an external library, SDK, framework, API, cloud service, CLI, or Kilo Code configuration, prefer official docs through MCP/docs tools such as `context7` when available.
